  ...
  <div className="content">
    ...
    <div className="infos-personels">
        ...
        <input type="text" name="nom" placeholder="Nom" className="" id="nom"
         value={reservation.nom} onChange={handleChange}/>
        </div>
        <div className="mb-2 inputs">
        <label htmlFor="prenom">Prenom</label>
        <input type="text" name="prenom" placeholder="Prenom" className="" id="prenom" 
        value={reservation.prenom} onChange={handleChange}/>
        </div>
    ...
    <div className="infos-personels">
        ...
        value={reservation.email} onChange={handleChange} />
        </div>
        <div className="mb-2 inputs">
        <label htmlFor="telephone">Telephone</label>
        <input type="number" name="telephone" placeholder="telephone" className="" id="telephone" 
        value={reservation.telephone} onChange={handleChange}/>
        </div>
    </div>
    ...
    id="vol"
    onChange={(e) => {
      const vol = dataVols.find(v => v.id === Number(e.target.value));
      console.log("vol trouver :",vol);
      
      console.log("id trouver", e.target.value);
      console.log("Liste des ids trouves", dataVols.map(v => v.id));
...
console.log("infos sur le vol trouver",vol);
  ...
  >
    ...
    {dataVols.map((vol,index)=><option key={index} value={vol.id}>
    ...
    <div className="infos-vol">
        ...
        value={infosVols.villeDepart} readOnly/>
        </div>
        <div className="mb-2 inputs">
        ...
        value={infosVols.villeArrivee} readOnly/>
        </div>
        </div>
        ...
        value={infosVols.dateDepart} readOnly
        />
        </div>
        <div className="mb-2 inputs">
        ...
        value={infosVols.dateArrivee} readOnly />
        </div>
        </div>
        ...
        value={infosVols.heureDepart?.substring(11, 16)} readOnly/>
        </div>
        <div className="mb-2 inputs">
        ...
        <input type="time" name="heureArrivee" placeholder="heureArrivee" className="" id="heureArrivee" 
         value={infosVols.heureArrivee?.substring(11,16)} readOnly/>
        </div>
        </div>
        ...
        value={infosVols.prix} readOnly/>
        </div>
        <div className="mb-2 inputs">
        <label htmlFor="duree">Duree</label>
        <input type="text" name="duree" placeholder="duree" className="" id="duree" 
        value={infosVols.duree} readOnly
        />
        </div>
        
        </div>
    
    <button type="submit" className="btn" style={{marginTop:"2rem"}} onClick={handleSubmit}>Valider</button>
    </form>
  </div>
  </>
};
