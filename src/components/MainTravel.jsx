      ...
      <div className="image mt-4">
        <div className="d-flex justify-content-center align-items-center flex-column text-travel text-center">
          ...
          <p className="mt-3">
            ...
            praesentium molestias error? Consequuntur corrupti illo assumenda
            laboriosam? Rerum aliquam reiciendis atque aliquid voluptates
            architecto dolore quibusdam? Perferendis voluptatum neque
            necessitatibus.
          </p>
        </div>
      </div>
